...
namespace Juice
{
	public class StringFormatOperatorBinder : ViewModelComponent, IViewModelInjector
	{
		public Type InjectionType => typeof(OperatorBinderVariableViewModel<string>);
		...
		protected virtual void Awake()
		{
			...
			ViewModel = new OperatorBinderVariableViewModel<string>(exposedProperty);
